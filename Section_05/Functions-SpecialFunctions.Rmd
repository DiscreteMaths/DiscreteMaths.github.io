...
* Similarly, the ceiling function maps x to the least integer greater than or equal to x, denoted ceil(x) or ⌈x⌉.[1]

* For example, ⌊2.4⌋ = 2, ⌊−2.4⌋ = −3, ⌈2.4⌉ = 3, and ⌈−2.4⌉ = −2.

* The integral part or integer part of x, often denoted [x] is usually defined as the ⌊x⌋ if x is nonnegative, and ⌈x⌉ otherwise.[citation needed] For example, [2.4] = 2 and [−2.4] = −2. 
