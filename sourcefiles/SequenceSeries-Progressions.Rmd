...
*  If the sequence goes on forever it is called an \textbf{infinite sequence},
...
A series is the sum of a sequence. For a given sequence $a_0,a_1,a_2,a_3,\ldots,a_n,\ldots$ the terms in the corresponding \emph{series} $s_n$ are given by
