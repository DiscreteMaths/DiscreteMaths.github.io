...
* It is common to refer to a sample space by the labels {\displaystyle S}S, ${\displaystyle \Omega }$ , or ${\displaystyle U}$ (for "universal set"). 
